...
to go-turtles
  ...
  ifelse shape = "person"  [
    ...
    ( ifelse
      ...
      enable-attack and dist < hit-radius and col != color [
        ask nearest [ be-hit kill-prob ]
      ]

      ; SEPARATE: if anyone too close, move away
      enable-separate and dist < separate-radius [
      ...
      ; COHERE (Foes)
      enable-cohere-foes and col != 0 and dist > cohere-radius and col != color and is-scout = 0 [
      ...
      ; COHERE (Friends)
      enable-cohere-friends and col != 0 and dist > cohere-radius and col = color and is-scout = 0 [
        set heading towards nearest
        wiggle
        fd max-speed
      ]
...
to-report emergence [values]
  let hist histogram-values values emergence-bins  ; histogram
  let c length values
...
"" ""
PENS
"X" 1.0 0 -16777216 true "" "plot emergence [xcor] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot emergence [ycor] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot emergence [heading] of turtles"
