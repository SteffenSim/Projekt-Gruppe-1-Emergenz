...
to go-turtles
  ...
  ifelse shape = "person"  [
    ...
    ( ifelse
      ...
      ; COHERE (Foes)
      enable-cohere-foes and (col != my-color or (foe-dist - dist < 0.4)) [ ;also cohere with enemy scouts
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot fix-emergence [neighbour-count] of turtles 0 100"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot fix-emergence [dist] of turtles 0 vision"
